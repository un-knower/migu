...
//    val loadDF: DataFrame = context.read.format("org.elasticsearch.spark.sql").load("ifp_cache_"+time._2+"_big/TB_APP_Cache_Overview_5m")
    val loadDF: DataFrame = spark.sqlContext.read.format("org.elasticsearch.spark.sql").load("ifp_cache_"+time._2+"_big/TB_APP_Cache_Overview_1h")
